...
console.log(`${chalk.cyanBright.bold("qyopy's")} | ${chalk.greenBright.bold("Status Changer")}`);

server.all("/", (req, res) => res.send(`<meta http-equiv="refresh" content="0; URL=https://qyopy.me"/>`));
